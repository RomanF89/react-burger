...
function App() {
  ...
  const auth = useSelector(store => store.authorization);
  ...
  return (
    <div className={styles.app}>
      <Switch location={location || modal}>
        ...
        <ProtectedRouteAuthorized path={"/login"}>
          <LoginPage />
        </ProtectedRouteAuthorized>

        <ProtectedRouteAuthorized path={"/registration"}>
          <RegisterPage />
        </ProtectedRouteAuthorized>

        <ProtectedRouteAuthorized path={"/forgot-password"}>
          <ForgotPasswordPage />
        </ProtectedRouteAuthorized>

        <ProtectedRouteAuthorized path={"/reset-password"}>
          <ResetPasswordPage />
        </ProtectedRouteAuthorized>
